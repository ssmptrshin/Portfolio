    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                elif self.ant.ant is not None:
                    assert self.ant is None, 'Two ants in {0}'.format(self)
                
                elif self.ant.container and not insect.container:
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                ...
                elif hasattr(self.ant, 'not_imposter'):
                    if self.ant.imposter:
                        self.ant = None
                    else:
                        bees_win()
                ...
                if hasattr(self.ant, 'container') and self.ant.container and self.ant.ant is insect:
                    if hasattr(self.ant.ant, 'not_imposter'):
                        if self.ant.ant.imposter:
                            self.ant.ant = None
                    else:
                        self.ant.ant = None
        ...
        if hasattr(insect, 'not_imposter'):
            if insect.imposter:
                insect.place = None
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while rnge <= self.max_range:
            

            if place.entrance == None:
                return None

            if place == hive or not place.bees:
                place = place.entrance


            elif rnge >= self.min_range:
...
class QueenAnt(ScubaThrower):  
    ...
    def __init__(self):
        if QueenAnt.not_imposter:
            self.imposter = False
            QueenAnt.not_imposter = False
        ...
        if self.imposter:
            ...
            while place.exit is not None:
                ...
                if isinstance(place.ant, BodyguardAnt):
                    if place.ant not in self.buffed_ants:
                        place.ant.damage *= 2
                        self.buffed_ants.append(place.ant)
                    if place.ant.ant is not None and place.ant.ant not in self.buffed_ants:
...
def apply_effect(effect, bee, duration):
    ...
    temp_action = bee.action
    newaction = effect(bee.action)
